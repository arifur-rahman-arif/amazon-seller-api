...
function onOpen(e) {
  ...
  function fetchInventory() {
    ...
    const apiUrl = `https://sellingpartnerapi-eu.amazon.com/fba/inventory/v1/summaries?details=${details}&granularityType=${granularityType}&granularityId=${granularityId}&marketplaceIds=${marketplaceIds}`;
